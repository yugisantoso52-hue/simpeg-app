        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('jenis-jabatan.update', $jenisJabatan->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('nama_jenis_jabatan', $jenisJabatan->nama_jenis_jabatan) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="keterangan"
                                      id="keterangan"
                                      rows="3"
                                      class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 px-3 py-2 text-sm text-gray-900 @error('keterangan') border-red-500 @enderror">{{ old('keterangan', $jenisJabatan->keterangan) }}</textarea>
                            @error('keterangan')
                                <p class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
