        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 flex items-center justify-between">
                    <div>
                        <h3 class="font-bold text-gray-500 text-sm uppercase tracking-wider">Dosen</h3>
                        <p class="text-3xl font-extrabold mt-2 text-indigo-600">{{ $statistik['dosen'] ?? 0 }}</p>
                    </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 flex items-center justify-between">
                    <div>
                        <h3 class="font-bold text-gray-500 text-sm uppercase tracking-wider">Pegawai PHL</h3>
                        <p class="text-3xl font-extrabold mt-2 text-amber-600">{{ $statistik['phl'] ?? 0 }}</p>
                    </div>
