<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ auth()->user()->hasRole('pegawai') ? route('pegawai.show', auth()->user()->pegawai_id) : (request('pegawai_id') ? route('pegawai.show', request('pegawai_id')) : route('riwayat-organisasi.index')) }}"
            ...
            <div class="bg-white shadow-sm rounded-xl border border-gray-200 p-6 md:p-8">
                ...
                <form action="{{ route('riwayat-organisasi.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                        <a href="{{ auth()->user()->hasRole('pegawai') ? route('pegawai.show', auth()->user()->pegawai_id) : route('riwayat-organisasi.index') }}"
