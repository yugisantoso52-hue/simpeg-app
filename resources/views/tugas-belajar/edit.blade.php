        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
                    <span>🎓</span> Edit Data Tugas Belajar / Izin Belajar
                </h2>
    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-xl border border-gray-200 p-6 md:p-8">
                ...
                <form action="{{ route('tugas-belajar.update', $data->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="jenis_pengembangan" id="jenis_pengembangan" required
                                    class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="Tugas Belajar" @selected(old('jenis_pengembangan', $data->jenis_pengembangan) == 'Tugas Belajar')>Tugas Belajar (Dibebastugaskan)</option>
                                <option value="Izin Belajar" @selected(old('jenis_pengembangan', $data->jenis_pengembangan) == 'Izin Belajar')>Izin Belajar (Tetap Melaksanakan Tugas)</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="jenjang_studi" id="jenjang_studi" required
                                    class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="S2" @selected(old('jenjang_studi', $data->jenjang_studi) == 'S2')>S2 (Magister)</option>
                                <option value="S3" @selected(old('jenjang_studi', $data->jenjang_studi) == 'S3')>S3 (Doktor)</option>
                                <option value="Spesialis" @selected(old('jenjang_studi', $data->jenjang_studi) == 'Spesialis')>Spesialis Keperawatan</option>
                                <option value="Subspesialis" @selected(old('jenjang_studi', $data->jenjang_studi) == 'Subspesialis')>Subspesialis</option>
                                <option value="Post Doctoral" @selected(old('jenjang_studi', $data->jenjang_studi) == 'Post Doctoral')>Post Doctoral</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="program_studi" id="program_studi" value="{{ old('program_studi', $data->program_studi) }}" required
                                   class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="perguruan_tinggi" id="perguruan_tinggi" value="{{ old('perguruan_tinggi', $data->perguruan_tinggi) }}" required
                                   class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="negara" id="negara" value="{{ old('negara', $data->negara) }}" required
                                   class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="sumber_pembiayaan" id="sumber_pembiayaan" required
                                    class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="Beasiswa BPI / Kemendikbud" @selected(old('sumber_pembiayaan', $data->sumber_pembiayaan) == 'Beasiswa BPI / Kemendikbud')>Beasiswa BPI / Kemendikbudristek</option>
                                <option value="Beasiswa LPDP" @selected(old('sumber_pembiayaan', $data->sumber_pembiayaan) == 'Beasiswa LPDP')>Beasiswa LPDP (Kemenkeu)</option>
                                <option value="Beasiswa Pemda" @selected(old('sumber_pembiayaan', $data->sumber_pembiayaan) == 'Beasiswa Pemda')>Beasiswa Pemerintah Daerah</option>
                                <option value="Mandiri / Swadana" @selected(old('sumber_pembiayaan', $data->sumber_pembiayaan) == 'Mandiri / Swadana')>Mandiri / Swadana</option>
                                <option value="Lainnya" @selected(old('sumber_pembiayaan', $data->sumber_pembiayaan) == 'Lainnya')>Lainnya (Luar Negeri / Universitas)</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_sponsor" id="nama_sponsor" value="{{ old('nama_sponsor', $data->nama_sponsor) }}"
                                   class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="nomor_sk" id="nomor_sk" value="{{ old('nomor_sk', $data->nomor_sk) }}" required
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_sk" id="tanggal_sk"
                                   value="{{ old('tanggal_sk', $data->tanggal_sk ? $data->tanggal_sk->format('Y-m-d') : '') }}"
                                   class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="date" name="tanggal_mulai" id="tanggal_mulai"
                                   value="{{ old('tanggal_mulai', $data->tanggal_mulai ? $data->tanggal_mulai->format('Y-m-d') : '') }}" required
                                   class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_selesai" id="tanggal_selesai"
                                   value="{{ old('tanggal_selesai', $data->tanggal_selesai ? $data->tanggal_selesai->format('Y-m-d') : '') }}" required
                                   class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="semester_berjalan" id="semester_berjalan" value="{{ old('semester_berjalan', $data->semester_berjalan) }}" min="1" max="20" required
                                   class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <select name="status_studi" id="status_studi" required
                                    class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="Sedang Studi" @selected(old('status_studi', $data->status_studi) == 'Sedang Studi')>Sedang Studi</option>
                                <option value="Perpanjangan" @selected(old('status_studi', $data->status_studi) == 'Perpanjangan')>Perpanjangan</option>
                                <option value="Lulus" @selected(old('status_studi', $data->status_studi) == 'Lulus')>Lulus / Selesai</option>
                                <option value="Dibatalkan / DO" @selected(old('status_studi', $data->status_studi) == 'Dibatalkan / DO')>Dibatalkan / DO</option>
                            </select>
                        </div>

                        <div>
                            <label for="file_sk" class="block text-sm font-semibold text-gray-700 mb-1">
                                Ganti Berkas SK Tubel (PDF)
                            </label>
                            <input type="file" name="file_sk" id="file_sk" accept=".pdf,.jpg,.jpeg,.png"
                                   class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                            @if($data->file_sk_url)
                                <div class="mt-1 text-xs text-gray-600">
                                    <a href="{{ $data->file_sk_url }}" target="_blank" class="text-indigo-600 hover:underline">Lihat SK saat ini</a>
                                </div>
                            @endif
                        </div>
                        ...
                        <div>
                            ...
                            @if($data->file_laporan_progress_url)
                                <div class="mt-1 text-xs text-gray-600">
                                    <a href="{{ $data->file_laporan_progress_url }}" target="_blank" class="text-teal-600 hover:underline">Lihat KHS saat ini</a>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" id="keterangan" rows="2"
                                  class="w-full rounded-lg border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('keterangan', $data->keterangan) }}</textarea>
                    </div>
